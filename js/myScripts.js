...
$(document).ready(function () {
    ...
    function StartApplication(data) {
       //---Innitialize Data----
        ...
        //-----3 ge all name hotels

        var HotelNames = hotels.map(x => x.hotelName); //pairneis ola ta hotel nanes
        autocompleteNames = [...new Set(HotelNames)]; //Destructuring Pairneis ola ta monadika onomata
        ...
        // --------ble bara------------ populate max attribute price in input range and change max price to input event---
        ...
        for (var guestRating of GuestRatings ) {
            ...
            if (guestRating == "Fair") guestRatingDrop.append(`<option value="${guestRating}">Okay 2-6</option>`);
       ...
       sortBy = sortByDrop.val();
        ...
        function Controller() {
            ...
            //Filtering
            if (cityName) {   //periexei auto p 8a grapsei o xristis to cityname? epestrepse mou autos p periexoun auto p exei grapsei o xristis
            ...
            console.log(filteredhotels.sort((a, b) => a.hotelName < b.hotelName ? -1 : 1));
            console.log(filteredhotels.sort((a, b) => a.hotelName > b.hotelName ? -1 : 1));
